...
//    }
 	...
 	function fetchItem($item){
		...
		CURLOPT_URL => "https://api.nutritionix.com/v1_1/search/'.$item.'?results=0:20&fields=item_name,brand_name,item_id,nf_calories,nf_sodium,nf_sugars,nf_protein,nf_totalcarbohydrate&appId=aac181c3&appKey=18d1adac27be37b70e42974393087394",
    ...
    function requestProcessor($request){
	    ...
	    case "calorietrack":
		return calorietrack($request['item'], $request['username']);
		break;
	    
	    case "attributesearch":
		return attributesearch($request['item'], $request['username']);
		break;
